...
function templates() {
  ...
  return prefix + fs.readdirSync(paths.templates).map(function(file) {
    ...
    // https://github.com/kangax/html-minifier/issues/805
    var options = Object.assign({}, opts.htmlMinifier, {removeAttributeQuotes: false});
    var data = htmlMinifier.minify(fs.readFileSync(p, "utf8"), options);
