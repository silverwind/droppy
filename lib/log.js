...
function response(req, res) {
    log(color.cyan, req.socket.remoteAddress, color.reset, ":", color.magenta, req.socket.remotePort, color.reset, " ", req.method.toUpperCase(), " ", decodeURIComponent(req.url), " ", res.statusCode);
}
